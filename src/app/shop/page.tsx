    ...
    <main className="relative overflow-hidden bg-[#050505] py-20 text-white">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 overflow-x-auto scrollbar-hide">
          <div className="flex w-max items-center gap-3 px-1 lg:w-full lg:flex-wrap lg:justify-center">
            {filters.map((filter) => (
              <button
                key={filter}
                onClick={() => setActiveFilter(filter)}
                className={`flex shrink-0 items-center gap-2 rounded-full border px-4 py-2 text-[9px] uppercase tracking-[0.22em] transition duration-300 sm:px-5 sm:py-3 sm:text-xs ${
                  activeFilter === filter
      ...
      <div className="group relative min-w-[155px] max-w-[155px] overflow-hidden rounded-[22px] border border-white/10 bg-[#0b0b0b] transition duration-500 hover:border-yellow-500/20 sm:min-w-[220px] sm:max-w-[220px] lg:min-w-0 lg:max-w-none">
        ...
        <div className="p-3 sm:p-4 lg:p-5">
          ...
          <div className="mt-3 flex items-center justify-between">
            ...
            <div className="flex h-8 items-center justify-center rounded-full border border-yellow-500/20 bg-yellow-500/10 px-3 text-[7px] uppercase tracking-[0.15em] text-yellow-400 transition duration-300 group-hover:bg-yellow-500/20 sm:h-9 sm:px-4 sm:text-[8px] lg:px-5 lg:py-2 lg:text-[10px]">
              View More
            </div>
          </div>
        </div>
